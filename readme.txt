...
In this project, we trained an Artificial learning agent which interacts with an environment with specific state which has a set of 
actions it can perform. Each state has many actions associated with it and each action leads to either a positive or negative 
